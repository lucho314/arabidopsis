...
if (isset($_POST['cuit'])) {
    echo $sql = "INSERT INTO `arabidopsis`.`usuarios` VALUES (NULL,0, 'colaborador-" . $_POST['nom_usuario'] . "-" . $_POST['cuit'] . "', "
    . "'" . $_POST['nom_usuario'] . "', '" . md5($_POST['pass']) . "', '2', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '" . $_POST['email'] . "', NULL, NULL); ";
    mysql_query($sql);
    $email = $_POST['email'];
    include_once('send_mail_colaborador.php');
}


if (isset($_GET['cuit'])) {
    $cuit = $_GET['cuit'];
    $sql = "UPDATE usuarios SET activo =1 WHERE descripcion LIKE  '%$cuit'";
    mysql_query($sql);
...
<div class="panel-body">
SE ENVIO UN MAIL A SU CORREO PARA CONFIRMAR LA CUENTA. REVISE SU BANDEJA DE ENTRADA.
	</div>
	</div>
<br><br><br>
</td></tr></table>
