...
if (empty($variablecontrol)) {
    $ne = new Scaffold(
            "noeditable", "proveedors", 0, array('descripcion'), array('empresa_id', 'descripcion'), // Campos a ocultar en el formulario
    ...
    new Scaffold(
            "noeditable", "proveedors", 30, array('razon_social', 'cuit', 'telefono'), array(), // Campos a ocultar en el formulario
            array(), // Campos relacionados
            array(), // Campos a ocultar del maestro en el detalle
