...
// configuracion
	...
	public $db_user = "root";
	public $db_password = ""; 
	public $db_name = "pymeser_arabidop";
				...
				*/}
                               elseif ($column->name == 'email') {
                                   $page .= '
                                            ...
                                            <td class="tabla_'.$column->name.'">
                                                <input type="text" required name="'.$column->name.'" id="'.$column->name.'" value="'.$valor_campo.'" size="35" />
                                                <img src="images/helpicon.gif" title="'.$comment.'" alt="'.$comment.'">
                                            </td>';
					...
					$page .= '
                                            ...
                                            <td class="tabla_'.$column->name.'">
                                                <input required class="mayuscula" type="text" name="'.$column->name.'" id="'.$column->name.'" value="'.$valor_campo.'" size="35" />
                                                <img src="images/helpicon.gif" title="'.$comment.'" alt="'.$comment.'">
                                            </td>';
				}
			}
	...
	function create($control=NULL){
		...
		//echo $last_id[0];
                ...
                $sql_maquina="INSERT INTO `registro_de_estados` (`id`, `descripcion`, `tabla`, `registro_id`, `fecha_cambio_estado`, `estado_id`, `usuario_id`, `empresa_id`) "
                        . "VALUES (NULL, '".$_POST['descripcion']."', '".$this->table."', $last_id[0], CURDATE(), $id_registro_creado, '".$_SESSION['usuario_id']."', '".$_POST['empresa_id']."');";
	...
	*/
	function update(){
		...
		$update .= '  WHERE id = '.intval($_POST['id']);
                ...
                $sql_maquina="INSERT INTO `registro_de_estados` (`id`, `descripcion`, `tabla`, `registro_id`, `fecha_cambio_estado`, `estado_id`, `usuario_id`, `empresa_id`) "
                        . "VALUES (NULL, '".$_POST['descripcion']."', '".$this->table."', '".$_POST['id']."', CURDATE(), $id_registro_creado, '".$_SESSION['usuario_id']."', '".$_POST['empresa_id']."');";
