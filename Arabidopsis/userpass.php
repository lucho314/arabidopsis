...
<div class="form-group">
    <label class="control-label col-sm-5" for="user">*Mail (user):</label>
        <div class="col-sm-2">
...
<div class="form-group">
        ...
        <div class="col-sm-10 col-sm-offset-1">
            <button class="btn btn-primary btn-block" type="submit" name="Submit" value="Entrar" style="
    margin-bottom: : 10px;
">Entrar</button>
     ...
     <a href="recuperar_contrasenia.html">Resetear contrase&ntilde;a</a>
     <br>
 </div>
</div>
</form>
