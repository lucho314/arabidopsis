...
die (header ("Location: /".$path."/index.php?mensaje=Debe estar registrado para acceder. Contacte al administrador"));
exit;
}*/
...
echo $sql_usuario = "SELECT id,usuario,pass,nivel_acceso FROM $sql_tabla WHERE usuario='".$_POST['user']."'";//die();
$usuario_consulta = mysql_query($sql_usuario) or die(/*header ("Location:  user_mal.php")*/ mysql_error());
