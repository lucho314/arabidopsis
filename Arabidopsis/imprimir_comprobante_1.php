...
$pdf->SetXY(57, 115);
$pdf->Write(0, str_replace('.',',',$datos_movieminto[0]) . " " . $moneda, '', 0, false, 'J', true, 0, false, false, 0);
...
if ($apertura === 'pre') {
    ...
    $to='luciano.zapata314@gmail.com';
    $subject='Recibo Fundacion Impulso de una nueva Vida';
    $cuerpo=' 
Hola estimado le adjunto el recibo N° 0004-1000.
Saludos cordiales!
';
    //$fileatt = $pdf->Output('recibo.pdf', 'E');
    $fileatt = $pdf->Output('recibo.pdf', 'S');
